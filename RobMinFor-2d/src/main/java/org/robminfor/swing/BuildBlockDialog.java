...
public class BuildBlockDialog extends JDialog {
	 ...
	 * @param parent
	 */
	public BuildBlockDialog(Frame parent, List<Site> selectedTmp,
		...
		{
			JLabel lblSelectParametersFor = new JLabel("Select item to place");
		...
		}
		{
			...
			list.setModel(new AbstractListModel() {
				public int getSize() {
					return EntityManager.getEntityManager().getBlockNames()
							.size();
				}
					...
					public void actionPerformed(ActionEvent e) {
						...
						if (valueObject != null) {
							...
							for (Site site : selected) {
								IBlock block = EntityManager.getEntityManager()
										.getBlock(selectedValue);
								// AbstractAction action = new Build(site,
								// block);
