...
public class OctaveNoise {
	...
	public double noise(double x, double y, double z) {
		...
		for (int i = 0; i < octaveCount; i++) {
			...
			double addedValue = triLerp(x, y, z, q000, q001, q010, q011, q100,
					q101, q110, q111, x1, y1, z1, x2, y2, z2);
	...
	private double value(double x, double y, double z) {
		...
		int seed = hash32shift(this.seed
				+ hash32shift(xd.hashCode()
						+ hash32shift(yd.hashCode()
								+ hash32shift(zd.hashCode()))));
	...
	/**
	 * x coordinate of target point x1 coordinate of lower grid corner x2
	 * coordinate of upper grid corner q0,q1 values at 4 grid corners
	 */
	...
	/**
	 * x,y coordinates of target point x1,y1 coordinates of lower grid corner
	 * x2,y2 coordinates of upper grid corner q11,q12,q21,q22 values at 4 grid
	 * corners
	 */
	private double biLerp(double x, double y, double q11, double q12,
	...
	/**
	 * x,y,z coordinates of target point x1,y1,z1 coordinates of lower grid
	 * corner x2,y2,z2 coordinates of upper grid corner
	 * q000,q001,q010,q011,q100,q101,q110,q111 values at 8 grid corners
	 */
	private double triLerp(double x, double y, double z, double q000,
			double q001, double q010, double q011, double q100, double q101,
			double q110, double q111, double x1, double y1, double z1,
